<div class="max-w-7xl font-sans font-normal mx-auto px-4 sm:px-6 lg:px-8 flex gap-10 py-12">
    <div class=" w-64">
        <ul class="flex py-15">
            ...
            <a class="mb-2 py-2 rounded-md flex justify-center text-white bg-slate-700">Categorias</a>

            @forelse ($categories as $category)
                <a href="#" wire:click.prevent="filterByCategory('{{ $category->id }}')" class="mb-2 p-2 rounded-md flex bg-slate-700 items-center gap-2 text-white/60 hover:text-white text-xs capitalize">
            ...
            @endforelse
                <a href="#" wire:click.prevent="filterByCategory('')" class="mb-2 p-2 rounded-md flex bg-slate-700 items-center gap-2 text-white/60 hover:text-white text-xs capitalize">
    ...
    <div class ="w-full bg-slate-600 rounded-md min-h-screen">
        ...
        <div class="w-full gap-4 grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-4 py-2">
            @forelse($productos as $producto)
                <div  class="bg-slate-800 text-white via-blue-500 to-red-400 transform hover:scale-110 transition-transform duration-300 rounded-md p-2 h-48">
